...
export default function GamesLobby() {
  const games = [
    ...
    { id: 'typing', name: 'Cyber Typer', desc: '1v1 High-Speed Typing Arena. Prove your speed.', icon: '⌨️', color: '#FFD700' },
    { id: 'sudoku', name: 'Cyber Sudoku', desc: 'Number logic puzzle with dynamic difficulty and pristine styling.', icon: '🔢', color: '#FFD700' }
  ];
